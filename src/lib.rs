...
use models::hour_element::Element;
...
pub fn get_json_weather_data(params: QueryParams) -> Vec<Element>{
    ...
    let mut elements = Element::to_element_vec(&result.hourly).expect("No Vector with Elements returned.");
